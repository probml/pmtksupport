...
%                                   lambda||alpha_i||_1 + (1/2)||alphab_i|_2^2 
...
%         model: (optional) struct
%            model allows a RESTART of the algorithm. It allows to do
%            some iteration on a training set, stop the learning, and then
%            restart the learning on a new dataset. See the example file
%            for a practical illustration.
%
% Output: 
%         D: double m x p matrix   (dictionary)
%         model: struct (optional)
%
